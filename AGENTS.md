...
- **Round 6, wave 3** (patches 0026–0029 so far): Import from Arc — Spaces,
  ...
  (`docs/features/toolbar.md` T8–T12).
...
archived view) as 0028 and R6-25 (the address row) as 0029; the rest of
