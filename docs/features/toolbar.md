...
| T4 | A page whose colour would swallow the toolbar icons (a white page in dark mode, a dark page in light) leaves the row on the window ground. | probes 5 and 12 on example.com | built |
