...
Status: **Sc1–Sc3 planned**. Owner: spaces. Patch: none yet.
...
|---|---|---|---|
| Sc1 | With the coat on, the switcher draws only the active chip. No "+" and no inactive names. | `SwitcherRulesTest.ShareCoatHidesOtherChips` | planned |
