...
| W8 | Step 2's Arc block moves everything from Arc in one click — the sidebar, history and passwords, each a checkbox that starts checked (import I21) — and says that the passwords need one macOS keychain prompt. | live: `r7_arc_welcome` (pending: the screen was locked when this landed on 2026-09-05; taken at the next unlock) | built · capture pending |
