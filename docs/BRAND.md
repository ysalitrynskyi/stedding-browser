...
A stedding is a haven — a settled, kept place, named after the English
word "steading", a farmstead or homestead. Inside a stedding you cannot be
reached by the force that shapes everything outside it.
...
- **We use only the word.** "Stedding" appears as a name for this browser and
  nothing more. No other party's trademarks, logos, cover art, illustrations,
...
- **No claimed affiliation.** We do not state or imply endorsement by, or
  association with, any company, publisher, studio, estate, or other rights
  holder. The origin story above is told as etymology, not association.
- **Ordinary word, distinct goods.** The browser is desktop software, named
  with an English-rooted word and shipped in a category far from any
  entertainment property. We lean on the word's plain English roots ("stead,"
  "steading"). This is a hygiene policy, not legal advice; if a rights holder
  ever objects, we engage in good faith.
